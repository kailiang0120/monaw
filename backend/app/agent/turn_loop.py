...
class TurnLoop:
    ...
    async def _react_worker(
        ...
        def _finish_trajectory(*, success: bool, error: str = "", assistant_message: str = "") -> None:
            nonlocal trajectory_finished
            ...
            try:
                ...
                if content:
                    self.trajectory_logger.add_entry(conversation_id, "gpt", content)
                self.trajectory_logger.finish(
                    conversation_id,
                    success=success,
                    error=error,
                    total_tokens=0,
                ...
                logger.debug("trajectory logging failed conversation_id=%s", conversation_id, exc_info=True)
        ...
        try:
            ...
            self.trajectory_logger.add_entry(conversation_id, "human", message)
