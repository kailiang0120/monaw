...
describe('ObservabilityPanel', () => {
  beforeEach(() => {
    ...
    mocks.fetchEvaluationRuns.mockResolvedValue([])
    mocks.replayEvaluationRun.mockResolvedValue({
      source_run_id: 'legacy-1',
      conversation_id: 'replay-legacy',
      status: 'complete',
      summary: 'done',
      errors: [],
    })
