...
export function InputBar({
  ...
  const recordingTimeoutRef = useRef<ReturnType<typeof window.setTimeout> | null>(null)
  const recordingSegmentTimeoutRef = useRef<ReturnType<typeof window.setTimeout> | null>(null)
